...
<!--                </div>-->
                            ...
                            <div class="condition_right">
                                ...
                                <div class="retext"
                                    ...
                                    <svg class="retext_trigon"
                                         fill="#efefef">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                             xlink:href="#trigon"></use>
                                    </svg>
                                    <div class="retext_like clear"
                                         :class="{likeborder : item.comment.length >0 }"
                                         v-show="item.like.length > 0">
                                        <svg class="retext_like_svg"
                                             fill="#8792b0">
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 xlink:href="#like"></use>
                                        </svg>
                                        <span v-for="(value,likeIndex) in item.like"
                                              :key="likeIndex">{{value}}<i>,</i></span>
                                    </div>
                                    <div class="retext_revert"
                                         v-show="item.comment.length > 0">
                                        <ul>
                                            <li v-for="(value,commentIndex) in item.comment"
                                                :key="commentIndex">
                ...
                <section class="criticism"
                    ...
                    <div class="criticism_con">
                        ...
                        <span :class="{notempty:changeinput}"
                              @click="commentSend">发送</span>
                    </div>
                </section>
            </section>
        </section>
